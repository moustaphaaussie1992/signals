                    ...
                    <div class="wideget-user mb-2">
                        <div class="row">
                                            ...
                                            <div class="me-5 mt-5 mt-md-0">
                                                <div class="media mb-4 d-flex">
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        <div class="fw-semibold fs-25">
                                                            <?php
                                                            $wonForexSignals = Utils::getSignalForexCountWinByUserId($user["id"]);
                                                            echo $wonForexSignals;
                                                            ?>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="col-xl-3">
                                <div class="card">
                                    <div class="card-header">
                                        <div class="card-title">Forex Percentage</div>
                                    </div>
                                    <div class="card-body">
                                        <div class="main-profile-contact-list">
                                            <div class="me-5">
                                                <div class="media mb-4 d-flex">
                                                    ...
                                                    <div class="media-body">
                                                        <span class="text-muted">Net Forex Signals Profit</span>
                                                        <div class="fw-semibold fs-25">
                                                            <?= $netProfit ?>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="me-5 mt-5 mt-md-0">
                                                <div class="media mb-4 d-flex">
                                                    ...
                                                    <div class="media-body">
                                                        <span class="text-muted">Won Forex Signals Profit</span>
                                                        <div class="fw-semibold fs-25">
                                                            <?= $wonProfit
                                                            ?>
                                                        </div>
                                            ...
                                            <div class="me-5 mt-5 mt-md-0">
                                                <div class="media mb-4 d-flex">
                                                    ...
                                                    <div class="media-body">
                                                        <span class="text-muted">Loss Forex Signals Profit</span>
                                                        <div class="fw-semibold fs-25">
                                                            <?= $lossProfit ?>
                                                        </div>
                                                    </div>
