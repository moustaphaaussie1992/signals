                                                ...
                                                <div class="card-body px-1">
                                                    <div class="d-flex overflow-visible">
                                                        <a href="blog-details.html"
                                                           ...
                                                           data-bs-image-src="<?= $sashPath ?>/assets/images/media/12.jpg"
                                                           style="background: url(&quot;<?= $sashPath ?>/assets/images/media/12.jpg&quot;) center center;"></a>
                                            ...
                                            <div class="card bg-transparent reveal">
                                                <div class="card-body px-1">
                                                    <div class="d-flex overflow-visible">
                                                        <a href="blog-details.html"
                                                           class="card-aside-column br-5 cover-image"
                                                           data-bs-image-src="<?= $sashPath ?>/assets/images/media/22.jpg"
                                                           style="background: url(&quot;<?= $sashPath ?>/assets/images/media/22.jpg&quot;) center center;"></a>
                                                        <div class="ps-3 flex-column">
                                                            <span
                                            ...
                                            <div class="card bg-transparent reveal">
                                                <div class="card-body px-1">
                                                    <div class="d-flex overflow-visible">
                                                        <a href="blog-details.html"
                                                           class="card-aside-column br-5 cover-image"
                                                           data-bs-image-src="<?= $sashPath ?>/assets/images/media/about.jpg"
                                                           style="background: url(&quot;<?= $sashPath ?>/assets/images/media/about.jpg&quot;) center center;"></a>
                                                        <div class="ps-3 flex-column">
                                                            <span
                                            ...
                                            <div class="card bg-transparent reveal">
                                                <div class="card-body px-1">
                                                    <div class="d-flex overflow-visible">
                                                        <a href="blog-details.html"
                                                           class="card-aside-column br-5 cover-image"
                                                           data-bs-image-src="<?= $sashPath ?>/assets/images/media/25.jpg"
                                                           style="background: url(&quot;<?= $sashPath ?>/assets/images/media/25.jpg&quot;) center center;"></a>
                                                        <div class="ps-3 flex-column">
                                    ...
                                    <div class="col-lg-4 col-sm-12 col-md-4 reveal revealleft">
                                        <div class="">
                                            <a href="index.html"><img loading="lazy" alt="" class="logo-2 mb-3"
                                                                      src="<?= $sashPath ?>/assets/images/brand/logo-3.png"></a>
